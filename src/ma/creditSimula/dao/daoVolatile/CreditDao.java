...
public class CreditDao implements IDao<Credit,Long> {
   ...
   static Set<Credit> BD_Credit(){
       ...
       Arrays.asList(
               new Credit(1L,30000000.0,120,2.5,"anass",0.0),
       new Credit(2L,2000000.0,120,3.5,"baydidi",0.0),
       new Credit(1L,3000000.0,120,2.5,"ahmed",0.0),
       new Credit(4L,4000000.0,30,2.0,"karim",0.0)
